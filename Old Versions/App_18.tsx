...
export default function App() {
    ...
    // אם יוצאים ממצב TRIPLE — מנטרלים דקירה אוטומטית
    useEffect(() => {
        if (mode !== "TRIPLE" && triplePickArmed) setTriplePickArmed(false);
    }, [mode, triplePickArmed]);
    ...
    useEffect(() => {
        ...
        map.on("click", (ev) => {
            ...
            if (!t) {
                setEnd(ll);
                // אחרי דקירת היעד — מנטרלים את הכפתור כדי למנוע קליקים בטעות
                ...
                <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginBottom: 12 }}>
                    {[
                        ...
                        <button
                            ...
                            onClick={() => {
                                if (b.id === "TRIPLE") {
                                    // מצב "3 מסלולים" משמש גם ככפתור דקירה (armed)
                                    setMode("TRIPLE");
