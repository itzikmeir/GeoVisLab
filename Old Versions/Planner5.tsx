...
function buildParticipantHtml(args: {
    ...
    const payload = {
        ...
        colors: {
            ...
            traffic: "#FF0022",
            toll: "#FFE100",
            comm: { fill: "rgba(170,60,255,0.1)", outline: "rgba(170,60,255,0.25)" },
...
<style>
    /* GLOBAL FONT RESET - SAN-SERIF STACK */
    * { box-sizing: border-box; user-select: none; font-family: system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif !important; }
...
.stack-label, .heatmap-cell, .radar-chart text {
  ...
  /* Task Panel */
    .taskPanel {font-family: system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif; width: 430px; max-width: 40%; display: flex; flex-direction: column; gap: 12px; padding: 16px; direction: rtl; text-align: right; overflow-y: auto; }
  ...
  .recLabel { font-size: 20px !important; font-weight: normal; color: #e8eefc; }
    .recVal { font-family: system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif !important; font-size: 20px !important; font-weight: 800; color: #60A5FA; }
  ...
  .vizPanel { 
      ...
      padding: 12px; 
      direction: rtl; 
      overflow: visible !important; /* חשוב מאוד כדי שהמשולש לא ייחתך */ 
      display: flex; 
      flex-direction: column;
  ...
  .legColorBox { width: 14px; height: 14px; margin-top: 3px; border-radius: 3px; flex-shrink: 0; }
    .legContent { display: flex; flex-direction: column; font-family: system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif !important;}
    .legTitle { font-weight: 800; font-size: 14px; font-family: system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif !important;}
    .legDesc { font-size: 12px; opacity: 0.7; margin-top: 2px; font-family: system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif !important;}
...
<div class="root">
  ...
  <div class="bottom">
    ...
    <div class="vizPanel panel">
         <div id="selected-route-indicator"></div> <div id="viz-container"></div>
    </div>
...
function text(x,y,t,sz,f){
    ...
    el.setAttribute('x',x); el.setAttribute('y',y); el.setAttribute('text-anchor','middle'); el.setAttribute('font-size',sz); el.setAttribute('fill',f); el.setAttribute('font-family','system-ui, -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif'); el.textContent=t;
    return el;
}
    ...
    if (vizType === 'HEATMAP') {
        ...
        segments.forEach((seg, idx) => {
             ...
             cats.forEach((c, i) => {
                 ...
                 // עיצוב טקסט
                 textEl.setAttribute("style", "font-family: system-ui, -apple-system, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; font-weight: 900; font-size: 40px !important; paint-order: stroke fill; stroke: rgba(0,0,0,0.8); stroke-width: 3px; stroke-linecap: round; stroke-linejoin: round;");
...
// Initial Render
selectRoute(picked);
updateIndicatorPosition(); // הוסף כאן כדי שיופיע מיד בהתחלה
try { drawMap(); } catch(e){}
...
function ensureOverlay(map: maplibregl.Map) {
    ...
    if (!map.getLayer("triple-badge-text")) {
        map.addLayer({
            ...
            layout: {
                "text-field": ["to-string", ["get", "label"]],
                "text-font": ["Arial","Helvetica Neue","Segoe UI","Roboto","Noto Sans"],
                "text-size": 14,
                "text-anchor": "center",
                "text-max-width": 999,
                "text-justify": "center",
