            ...
            >
                ...
                <div style={{ background: "rgba(255,255,255,0.06)", borderRadius: 12, padding: 12, marginBottom: 12 }}>
                    ...
                    {[
                        ...
                        { label: "פארקים (LANDCOVER)", v: showBaseParks, set: setShowBaseParks },
                        { label: "פארקים ידניים", v: showManualParks, set: setShowManualParks },
                            ...
                            <div style={{ marginTop: 12, paddingTop: 12, borderTop: "1px solid rgba(255,255,255,0.12)" }}>
                                ...
                                <button
                                    ...
                                    style={{
                                        ...
                                        borderRadius: 10,
                                        border: "1px solid rgba(255,255,255,0.15)",
                                        background: showVisualizations ? "rgba(140,203,255,0.18)" : "rgba(255,255,255,0.06)",
                                        color: "white",
